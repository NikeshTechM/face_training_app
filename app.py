...
if __name__ == "__main__":
    ...
    parser.add_argument('--output-dir', type=str, default='/app/shared', help='Directory for downloads and models')
    ...
    parser.add_argument('--api-url', type=str, default= 'https://02eq797xsg.execute-api.us-east-1.amazonaws.com/Dev/sdvDevopsGetNewDriverAPI', help='API URL for fetching image data')
